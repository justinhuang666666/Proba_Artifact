...
public:
    ...
    Entry insert(uint64_t region_num, uint64_t trigger_offset, uint64_t pc, uint64_t addr);
...
private:
    ...
    std::vector<PatternHistoryTable> phts;
    JailTable jt;
    FilterTable ft;
    PrefetchBuffer pb;

    int sample_rate = 10;
    int proba_acc_thr1 = 60;
    int proba_acc_thr2 = 40;
