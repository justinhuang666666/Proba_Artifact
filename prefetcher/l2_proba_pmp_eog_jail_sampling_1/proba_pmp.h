...
public:
    PCPatternTable(int size, int num_ways, int pc_width);
...
public:
    ...
    Proba(int agt_size, int agt_ways, int opt_size, int opt_ways, int offset_width, int ppt_size, int ppt_ways, int pc_width, int jt_size, int pb_size, int pb_ways, bool is_debug, int cpu);
