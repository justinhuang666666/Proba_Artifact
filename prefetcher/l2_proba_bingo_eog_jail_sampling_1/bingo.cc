...
void CACHE::prefetcher_initialize() {
    ...
    prefetchers = std::vector<bingo_pb::Bingo>(NUM_CPUS, bingo_pb::Bingo(bingo_pb::REGION_SIZE >> LOG2_BLOCK_SIZE, bingo_pb::MIN_ADDR_WIDTH, bingo_pb::MAX_ADDR_WIDTH, bingo_pb::KEY_WIDTH, bingo_pb::AT_SIZE, bingo_pb::AT_WAY, bingo_pb::PHT_SIZE, bingo_pb::PHT_WAY, bingo_pb::JT_SIZE, bingo_pb::PB_SIZE, bingo_pb::PB_WAY, 0));
}
