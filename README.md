...
| `sms`         | [Spatial Memory Streaming](https://web.eecs.umich.edu/~twenisch/papers/isca06.pdf), ISCA 2006                                                                      |
| `bingo`       | [Bingo Spatial Data Prefetcher](https://doi.org/10.1109/HPCA.2019.00053), HPCA 2019                                                                                |
| `dspatch`     | [DSPatch: Dual Spatial Pattern Prefetcher](https://arxiv.org/abs/1910.03075), MICRO 2019                                                                           |
| `pmp`         | [Merging Similar Patterns for Hardware Prefetching](https://doi.org/10.1109/MICRO56248.2022.00071), MICRO 2022                                                     |
| `gaze`        | [Gaze into the Pattern: Characterizing Spatial Patterns with Internal Temporal Correlations for Hardware Prefetching](https://arxiv.org/abs/2412.05211), HPCA 2025 |
